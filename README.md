![Example-Logo](https://i.imgur.com/9D0fCZi.png)
# Pyro Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Pyro Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discordapp.com/invite/2ubbnGq)
***
## Requirements
1) **1,000  PYRO coins.**
...
***Step 1***
* Download and install the PYRO wallet [here](https://github.com/pyrocoindev/pyro/releases)
***

***Step 2***
* Send EXACLY 1,000 PYRO to a receive address within your wallet.
***
